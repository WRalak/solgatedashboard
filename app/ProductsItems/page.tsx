...
const Dashboard = () => {
  ...
  const stats = [
    { icon: <IoStatsChartOutline />, label: "No of live products", number: "87,000.50" },
    { icon: <LuShirt />, label: "No of products", number: "45" },
    { icon: <RiMoneyDollarBoxLine />, label: "No of solid products", number: "30,000.00" },
